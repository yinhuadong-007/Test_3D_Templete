...
public class TestConfBalanceThirdController : MonoBehaviour
{
    ...
    TestConfBalanceRotate m_BalanceRotation;
...

    {
        ...
        m_BalanceRotation = GetComponent<TestConfBalanceRotate>();
    ...
    private void FixedUpdate()
    {
        ...
        m_BalanceRotation.SetTargetRotate2(m_Cam.forward);
        // if (localMove.z != 0)
        // {
